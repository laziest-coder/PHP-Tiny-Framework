...
class Paginator
{
    ...
    public function toHtml()
    {
        ...
        foreach ($this->getPages() as $page) {
            if ($page['url']) {
                $html .= '<li' . ($page['isCurrent'] ? ' class="active"' : '') . ' style="border: 1px solid black;padding: 5px;margin:5px;"><a href="' . htmlspecialchars($page['url']) . '">' . htmlspecialchars($page['num']) . '</a></li>';
            } else {
